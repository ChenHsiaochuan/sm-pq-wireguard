...
impl<O> Peer<O> {
    pub fn new(pk: PublicKey, pk_pq: oqs::kem::PublicKey, own_pk_pq: &oqs::kem::PublicKey, ss: [u8; 32], opaque: O) -> Self {
        Self {
            opaque,
            ...
            psk: [0u8; 32],
            pk_hash: HASH!(pk.as_bytes(), <[u8; SIZE_STATIC_KEM_PUB_KEY]>::try_from(pk_pq.as_ref()).unwrap()).into(),
            pk: pk,
            pk_pq: pk_pq,
            k_send: Mutex::new(0),
            k_recv: Mutex::new(0),
