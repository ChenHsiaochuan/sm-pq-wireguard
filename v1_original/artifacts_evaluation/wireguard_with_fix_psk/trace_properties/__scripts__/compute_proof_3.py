...
def update_files(file_to_read, file_to_write):
	...
	with open(file_to_read, 'r') as infile:
		...
		filedata = filedata.replace("new dhekI_2:bitstring;", "new dhekI_2[]:bitstring;")
		...
		filedata = filedata.replace("new dhekR_2:bitstring;", "new dhekR_2[]:bitstring;")
...
def update_files_lateral(file_to_read, file_to_write):
	...
	with open(file_to_read, 'r') as infile:
		...
		filedata = filedata.replace("new stamp_2:bitstring;", "new stamp_2[]:bitstring;")
		filedata = filedata.replace("new dhekR_2:bitstring;", "new dhekR_2[]:bitstring;")
		filedata = filedata.replace("if pk2_7 <> exp(g, ltk1) then", "if pk2_7 <> exp(g, ltk1_3) then")
		filedata = filedata.replace("if pk2_8 <> exp(g, ltk1) then", "if pk2_8 <> exp(g, ltk1_4) then")
...
def update_files_pfs(file_to_read, file_to_write):
	...
	with open(file_to_read, 'r') as infile:
		...
		filedata = filedata.replace("(RevealLDH(ldhI_2))", "(phase 1; RevealLDH(ldhI_2))")
		filedata = filedata.replace("(RevealLDH(ldhR_2))", "(phase 1; RevealLDH(ldhR_2))")
		filedata = filedata.replace("(RevealPRE(ldhI_2, ldhR_2))", "(phase 1; RevealPRE(ldhI_2, ldhR_2))")
