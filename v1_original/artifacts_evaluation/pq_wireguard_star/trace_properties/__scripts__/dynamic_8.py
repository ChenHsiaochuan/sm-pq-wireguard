...
with open("wireguard_command_8", "r") as infile, open('wireguard_command_8_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_8_1", "r") as infile, open('wireguard_command_8_2', 'w') as outfile:
...
os.remove("wireguard_command_8_1")
...
with open("wireguard_command_8_2", "r") as infile, open('wireguard_command_8_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_8_2")
...
with open("wireguard_command_8_3", "r") as infile, open('wireguard_command_8_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_8_3")
...
with open("wireguard_command_8_4", "r") as infile, open('wireguard_command_8_5', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_8_4")
...
with open("wireguard_command_8_5", "r") as infile, open('wireguard_command_8_6', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_8_5")
...
with open("wireguard_command_8_6", "r") as infile, open('wireguard_command_8_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_8_6")
