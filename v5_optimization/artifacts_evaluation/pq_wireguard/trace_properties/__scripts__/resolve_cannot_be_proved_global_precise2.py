...
replace_string_in_files("./resolve_global", "event eTest( stp1_1, kempekI_1 );", "")


replace_string_in_files("./resolve_global", "new stp1_1[]:bitstring;\n\t\t\tevent eTest( stp1_1, kempekI_1 );\n\n", "")
replace_string_in_files("./resolve_global", "axiom x: bitstring, y: bitstring, z: bitstring; event(eTest(x, y)) && event(eTest(x, z)) ==> y = z.", "")
replace_string_in_files("./resolve_global", "event eRevRe(bitstring).\nevent eTest(bitstring,bitstring).\n", "event eRevRe(bitstring).\n")


replace_string_in_files("./resolve_global", "free att:channel.", "set preciseActions = true.\nfree att:channel.")
