...
with open('wireguard_uniqueness_responder_export_queries.spthy', 'w') as f:
	...
	f.write("event(eRConfirm(ck, kemltki, kemltkr, ldhi, ldhr, kempeki, dheki, dhekr, psk, h(rb), h(ra), h(re))) && event(eRConfirm(ck, kemltki, kemltkr, ldhi, ldhr, kempeki', dheki', dhekr', psk, h(rb'), h(ra'), h(re')))"+'\n')
...
with open('wireguard_uniqueness_responder_export_queries.spthy', 'r') as f:
	fdata = f.read()
