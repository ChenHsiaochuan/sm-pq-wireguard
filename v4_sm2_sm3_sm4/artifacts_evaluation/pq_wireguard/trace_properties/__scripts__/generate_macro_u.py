...
shutil.copy(r"wireguard_process_u_reference.spthy", r"macro/wireguard_process_u_reference.spthy")
...
with open('wireguard_process_u_reference.spthy', 'r') as infile:
	filedata = infile.read()
...
with open('wireguard_process_u_reference.spthy.all_trusted', 'w') as outfile:
	outfile.write(filedata)
...
os.remove("wireguard_process_u_reference.spthy")
os.remove("wireguard_peer_responder_reference.spthy")

listfiles=sorted(os.listdir())

with open("wireguard_macro_u.spthy", "w") as outfile:
	for file in listfiles:
		with open(file, "r") as infile:
			outfile.write(infile.read())

shutil.copy(r"wireguard_macro_u.spthy", r"../wireguard_macro_u.spthy")
