...
with open("wireguard_command_5", "r") as infile, open('wireguard_command_5_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_5_1", "r") as infile, open('wireguard_command_5_2', 'w') as outfile:
...
os.remove("wireguard_command_5_1")
...
with open("wireguard_command_5_2", "r") as infile, open('wireguard_command_5_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_5_2")
...
with open("wireguard_command_5_3", "r") as infile, open('wireguard_command_5_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_5_3")
