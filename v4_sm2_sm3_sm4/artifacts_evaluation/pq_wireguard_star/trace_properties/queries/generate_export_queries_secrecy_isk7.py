...
with open('wireguard_secrecy_isk7_export_queries.spthy', 'w') as f:
	...
	f.write('event(eI_SK7(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && attacker(ck).'+'\n\n')
...
with open('wireguard_secrecy_isk7_export_queries.spthy', 'r') as f:
	fdata = f.read()
