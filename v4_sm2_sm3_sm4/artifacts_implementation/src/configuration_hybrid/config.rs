...
pub trait Configuration {
    ...
    fn set_private_key(&self, sk: Option<(DhSecretKey, oqs::kem::SecretKey, oqs::kem::PublicKey)>);
    ...
    fn get_private_key(&self) -> Option<(DhSecretKey, oqs::kem::SecretKey, oqs::kem::PublicKey)>;
    ...
    fn add_peer(&self, pk: DhPublicKey, pk_pq: &oqs::kem::PublicKey, pk_hash: &[u8; 32]) -> bool;
