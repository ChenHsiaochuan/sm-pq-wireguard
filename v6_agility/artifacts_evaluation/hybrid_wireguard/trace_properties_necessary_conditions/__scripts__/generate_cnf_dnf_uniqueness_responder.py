...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		data = infile.read()
		if(data == 'NULL'):
			resfile.write("DNF for uniqueness_responder: \u2205\n")
			resfile.write("CNF for uniqueness_responder: \u2205\n")
		else:
			...
			resfile.write("DNF for uniqueness_responder: "+str(dnf)+"\n")
			resfile.write("CNF for uniqueness_responder: "+str(cnf)+"\n")

res2dnf("process_read_access/uniqueness_responder/wireguard_uniqueness_responder.pv.log")