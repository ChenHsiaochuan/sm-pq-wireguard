...
with open('wireguard_unilateral_initiator_export_queries.spthy', 'w') as f:
	...
	f.write("query kemltki:bitstring, kemltkr:bitstring, kemltkr':bitstring, kempeki:bitstring, psk:bitstring, ck:bitstring, rb:bitstring, ra:bitstring, re:bitstring;"+'\n')
	...
	for l in sets_list:
		...
		for j in range(0, len(l)):
			...
			query = "query kemltki:bitstring, kemltkr:bitstring, kemltkr':bitstring, kempeki:bitstring, psk:bitstring, ck:bitstring, rb:bitstring, ra:bitstring, re:bitstring"
