...
with open('wireguard_agreement_inithello_export_queries.spthy', 'w') as f:
	...
	f.write('event(eRRec(ck, kemltki, kemltkr, tpkr, kempeki, psk, h((rb, tpki)), h((ra, tpkr)), h(re)))'+'\n')
	f.write('==> event(eISend(ck, kemltki, kemltkr, tpki, kempeki, psk, h((rb, tpki)))).'+'\n\n')
	...
	for l in sets_list:
		...
		for j in range(0, len(l)):
			...
			event ='==> event(eISend(ck, kemltki, kemltkr, tpki, kempeki, psk, h((rb, tpki)))) || '
