...
with open("wireguard_command_7", "r") as infile, open('wireguard_command_7_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_7_1", "r") as infile, open('wireguard_command_7_2', 'w') as outfile:
...
os.remove("wireguard_command_7_1")
...
with open("wireguard_command_7_2", "r") as infile, open('wireguard_command_7_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_7_2")
...
with open("wireguard_command_7_3", "r") as infile, open('wireguard_command_7_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_7_3")
...
with open("wireguard_command_7_4", "r") as infile, open('wireguard_command_7_5', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_7_4")
...
with open("wireguard_command_7_5", "r") as infile, open('wireguard_command_7_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_7_5")
