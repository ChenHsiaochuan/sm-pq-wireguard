...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		data = infile.read()
		if(data == 'NULL'):
			resfile.write("DNF for secrecy_mul7: \u2205\n")
			resfile.write("CNF for secrecy_mul7: \u2205\n")
		else:
			...
			resfile.write("DNF for secrecy_mul7: "+str(dnf)+"\n")
			resfile.write("CNF for secrecy_mul7: "+str(cnf)+"\n")
