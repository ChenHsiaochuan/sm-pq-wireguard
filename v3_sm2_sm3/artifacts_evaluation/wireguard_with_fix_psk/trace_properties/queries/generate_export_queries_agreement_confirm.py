...
with open('wireguard_agreement_confirm_export_queries.spthy', 'w') as f:
	...
	f.write('event(eRConfirm(ck, ldhi, ldhr, dheki, dhekr, psk))'+'\n')
	f.write('==> event(eIConfirm(ck, ldhi, ldhr, dheki, dhekr, psk)).'+'\n\n')
	...
	for l in sets_list:
		...
		for j in range(0, len(l)):
			...
			event ='==> event(eIConfirm(ck, ldhi, ldhr, dheki, dhekr, psk)) || '
