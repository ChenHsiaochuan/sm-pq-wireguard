...
use crate::wireguard_pq_star::handshake::crypto_params::SIZE_HASH;
use super::udp::Owner;
use super::*;
...
pub trait Configuration {
    ...
    fn set_private_key(&self, sk: Option<(oqs::kem::SecretKey, oqs::kem::PublicKey)>);
    ...
    fn get_private_key(&self) -> Option<(oqs::kem::SecretKey, oqs::kem::PublicKey)>;
    ...
    fn add_peer(&self, pk_pq: &oqs::kem::PublicKey, pk_hash: &[u8; 32]) -> bool;
...
impl<T: tun::Tun, B: udp::PlatformUDP> Configuration for WireGuardConfig<T, B> {
    ...
    fn add_peer(&self, pk_pq: &oqs::kem::PublicKey, pk_hash: &[u8; 32]) -> bool {
        self.lock().wireguard.add_peer(pk_pq, pk_hash)
    }
