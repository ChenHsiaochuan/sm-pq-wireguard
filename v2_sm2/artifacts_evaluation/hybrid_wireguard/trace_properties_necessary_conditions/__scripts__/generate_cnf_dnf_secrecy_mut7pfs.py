...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		data = infile.read()
		if(data == 'NULL'):
			resfile.write("DNF for secrecy_mut7pfs: \u2205\n")
			resfile.write("CNF for secrecy_mut7pfs: \u2205\n")
		else:
			...
			resfile.write("DNF for secrecy_mut7pfs: "+str(dnf)+"\n")
			resfile.write("CNF for secrecy_mut7pfs: "+str(cnf)+"\n")

res2dnf("process_read_access/secrecy_mut7pfs/wireguard_secrecy_mut7pfs.pv.log")
