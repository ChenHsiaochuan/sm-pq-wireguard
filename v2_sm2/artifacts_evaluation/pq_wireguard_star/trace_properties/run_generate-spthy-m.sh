...
queryintro="query kemltki:bitstring, kemltkr:bitstring, kemltki':bitstring, kemltkr':bitstring, kempeki:bitstring, kempeki':bitstring, psk:bitstring, psk':bitstring, ck:bitstring, rb:bitstring, ra:bitstring, re:bitstring, rb':bitstring, ra':bitstring, re':bitstring;"

query_secrecy_isk7="event(eI_SK7(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && attacker(ck)."
query_secrecy_rsk7="event(eR_SK7(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && attacker(ck)."
query_secrecy_mut7="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && attacker(ck)."
query_agreement_inithello="event(eRRec(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) ==> event(eISend(ck, kemltki, kemltkr, kempeki, psk, h((rb, tpki))))."
query_agreement_rechello="event(eIKeys(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) ==> event(eRKeys(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re)))."
query_agreement_confirm="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) ==> event(eIConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re)))."
query_uniqueness_initiator="event(eIConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki, kemltkr, kempeki', psk, h(rb'), h(ra), h(re))) ==> ((kempeki = kempeki') && (rb = rb'))."
query_uniqueness_responder="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eRConfirm(ck, kemltki, kemltkr, kempeki', psk, h(rb), h(ra'), h(re'))) ==> ((kempeki = kempeki') && (ra = ra') && (re = re'))."
query_unilateral_initiator="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki, kemltkr', kempeki', psk', h(rb), h(ra), h(re))) ==> (kemltkr = kemltkr')."
query_unilateral_responder="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki', kemltkr, kempeki', psk', h(rb), h(ra), h(re))) ==> (kemltki = kemltki')."
query_bilateral="event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki', kemltkr', kempeki', psk', h(rb), h(ra), h(re))) ==> ((kemltki = kemltki') && (kemltkr = kemltkr'))."
