...
with open('wireguard_secrecy_mut7pfs_export_queries.spthy', 'w') as f:
	...
	f.write('event(eRConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && event(eIConfirm(ck, kemltki, kemltkr, kempeki, psk, h(rb), h(ra), h(re))) && attacker(ck).'+'\n\n')
...
with open('wireguard_secrecy_mut7pfs_export_queries.spthy', 'r') as f:
	fdata = f.read()
