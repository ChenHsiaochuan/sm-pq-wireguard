...
Sc = S1c+S2c+S3c+S4c+S5c+S6c+S7c
...
def tamarin_proverif_unilateral_initiator():
	...
	update_files('wireguard_unilateral_initiator.p', 'wireguard_unilateral_initiator.pv')
...
def tamarin_proverif_unilateral_responder():
	...
	update_files('wireguard_unilateral_responder.p', 'wireguard_unilateral_responder.pv')
...
def tamarin_proverif_bilateral():
	...
	update_files('wireguard_bilateral.p', 'wireguard_bilateral.pv')
