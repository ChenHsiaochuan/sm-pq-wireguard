...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		data = infile.read()
		if(data == 'NULL'):
			resfile.write("DNF for unilateral_initiator: \u2205\n")
			resfile.write("CNF for unilateral_initiator: \u2205\n")
		else:
			...
			resfile.write("DNF for unilateral_initiator: "+str(dnf)+"\n")
			resfile.write("CNF for unilateral_initiator: "+str(cnf)+"\n")

res2dnf("process_read_access/unilateral_initiator/wireguard_unilateral_initiator.pv.log")