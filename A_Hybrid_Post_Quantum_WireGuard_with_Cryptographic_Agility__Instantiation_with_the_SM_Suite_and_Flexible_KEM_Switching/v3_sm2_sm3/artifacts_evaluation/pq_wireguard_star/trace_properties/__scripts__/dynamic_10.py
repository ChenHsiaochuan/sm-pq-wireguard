...
with open("wireguard_command_10", "r") as infile, open('wireguard_command_10_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_10_1", "r") as infile, open('wireguard_command_10_2', 'w') as outfile:
...
os.remove("wireguard_command_10_1")
...
with open("wireguard_command_10_2", "r") as infile, open('wireguard_command_10_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_2")
...
with open("wireguard_command_10_3", "r") as infile, open('wireguard_command_10_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_3")
...
with open("wireguard_command_10_4", "r") as infile, open('wireguard_command_10_5', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_4")
...
with open("wireguard_command_10_5", "r") as infile, open('wireguard_command_10_6', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_5")
...
with open("wireguard_command_10_6", "r") as infile, open('wireguard_command_10_7', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_6")
...
with open("wireguard_command_10_7", "r") as infile, open('wireguard_command_10_8', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_7")
...
with open("wireguard_command_10_8", "r") as infile, open('wireguard_command_10_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_10_8")
