...
subkeys = ["eRevKEMLtk(kemltki", "eRevKEMLtk(kemltkr", "eRevKEMEki", "eRevRa", "eRevRb", "eRevRe", "eRevPsk"]
replacement = {"eRevKEMLtk(kemltki": "_kemltki", "eRevKEMLtk(kemltkr": "_kemltkr", "eRevKEMEki": "_kemeki", "eRevRa": "_ra", "eRevRb": "_rb", "eRevRe": "_re", "eRevPsk": "_psk"}
...
with open("wireguard_command_12", "r") as infile, open('wireguard_command_12_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_12_1", "r") as infile, open('wireguard_command_12_2', 'w') as outfile:
...
os.remove("wireguard_command_12_1")
...
with open("wireguard_command_12_2", "r") as infile, open('wireguard_command_12_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_2")
...
with open("wireguard_command_12_3", "r") as infile, open('wireguard_command_12_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_3")
...
with open("wireguard_command_12_4", "r") as infile, open('wireguard_command_12_5', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_4")
...
with open("wireguard_command_12_5", "r") as infile, open('wireguard_command_12_6', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_5")
...
with open("wireguard_command_12_6", "r") as infile, open('wireguard_command_12_7', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_6")
...
with open("wireguard_command_12_7", "r") as infile, open('wireguard_command_12_8', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_12_7")
os.remove("wireguard_command_8.lg")


with open("wireguard_command_9.9log", "r") as infile:
	filedata = infile.read()
	newfiledata = re.sub(result, replace, filedata)
	#filedata = filedata.replace("RESULT event(eI_SK7(ck_2,ldhi,ldhr,dheki,dhekr,psk_4))@i && attacker(ck_2)@j ==>", "")
	with open("wireguard_command_9.lg", "w") as outfile:
		outfile.write(newfiledata)
infile.close()
outfile.close()
...
with open("wireguard_command_9.lg", "r") as infile:
	for line in infile:
		for keys in S9c:
			if ("is true" in line) and (keys[0] in line) and (keys[1] in line)  and (keys[2] in line) and (keys[3] in line)  and (keys[4] in line)   and (keys[5] in line)  and (keys[6] in line) and (keys[7] in line) and (keys[8] in line):
				comb9.append(keys)
infile.close()
...
for item in comb9:
	replaced_item = tuple(replacement.get(elem, elem) for elem in item)
	rep_comb9.append(replaced_item)


with open("wireguard_command_12_8", "r") as infile, open('wireguard_command_12_9', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
		if not any(all( word in line for word in keys) for keys in rep_comb9):
			filtered_lines.append(line)
	outfile.writelines(filtered_lines)

os.remove("wireguard_command_12_8")
os.remove("wireguard_command_9.lg")


with open("wireguard_command_10.10log", "r") as infile:
	filedata = infile.read()
	newfiledata = re.sub(result, replace, filedata)
	#filedata = filedata.replace("RESULT event(eI_SK7(ck_2,ldhi,ldhr,dheki,dhekr,psk_4))@i && attacker(ck_2)@j ==>", "")
	with open("wireguard_command_10.lg", "w") as outfile:
		outfile.write(newfiledata)
infile.close()
outfile.close()
...
with open("wireguard_command_10.lg", "r") as infile:
	for line in infile:
		for keys in S10c:
			if ("is true" in line) and (keys[0] in line) and (keys[1] in line)  and (keys[2] in line) and (keys[3] in line)  and (keys[4] in line)   and (keys[5] in line)  and (keys[6] in line) and (keys[7] in line) and (keys[8] in line) and (keys[9] in line):
				comb10.append(keys)
infile.close()
...
with open("wireguard_command_12_9", "r") as infile, open('wireguard_command_12_10', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
		if not any(all( word in line for word in keys) for keys in rep_comb10):
			filtered_lines.append(line)
	outfile.writelines(filtered_lines)

os.remove("wireguard_command_12_9")
os.remove("wireguard_command_10.lg")


with open("wireguard_command_11.11log", "r") as infile:
	filedata = infile.read()
	newfiledata = re.sub(result, replace, filedata)
	#filedata = filedata.replace("RESULT event(eI_SK7(ck_2,ldhi,ldhr,dheki,dhekr,psk_4))@i && attacker(ck_2)@j ==>", "")
	with open("wireguard_command_11.lg", "w") as outfile:
		outfile.write(newfiledata)
infile.close()
outfile.close()
...
with open("wireguard_command_11.lg", "r") as infile:
	for line in infile:
		for keys in S11c:
			if ("is true" in line) and (keys[0] in line) and (keys[1] in line)  and (keys[2] in line) and (keys[3] in line)  and (keys[4] in line)   and (keys[5] in line)  and (keys[6] in line) and (keys[7] in line) and (keys[8] in line) and (keys[9] in line) and (keys[10] in line):
				comb11.append(keys)
infile.close()
...
for item in comb11:
	replaced_item = tuple(replacement.get(elem, elem) for elem in item)
	rep_comb11.append(replaced_item)


with open("wireguard_command_12_10", "r") as infile, open('wireguard_command_12_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
		if not any(all( word in line for word in keys) for keys in rep_comb11):
			filtered_lines.append(line)
	outfile.writelines(filtered_lines)

os.remove("wireguard_command_12_10")
os.remove("wireguard_command_11.lg")
