...
extract_and_write_expression(input_filename, "secrecy_isk7.dnf", "secrecy_isk7")


generate_tamarin_lemma_secrecy_isk7("secrecy_isk7.dnf", variable_mapping_secrecy, "secrecy_isk7.lemma")