...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		...
		if(data == 'NULL'):
			...
			resfile.write("DNF for secrecy_rsk7: "+str(dnf)+"\n")
			resfile.write("CNF for secrecy_rsk7: "+str(cnf)+"\n")

res2dnf("process_read_access/secrecy_rsk7/wireguard_secrecy_rsk7.pv.log")
