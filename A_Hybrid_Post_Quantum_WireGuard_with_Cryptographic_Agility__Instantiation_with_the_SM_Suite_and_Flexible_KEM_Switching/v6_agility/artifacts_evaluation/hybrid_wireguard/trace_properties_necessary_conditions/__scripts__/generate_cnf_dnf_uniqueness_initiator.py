...
def res2dnf(arg1):
	...
	with open(arg1+'.dnf', 'r') as infile, open('results.cnfdnf', 'a') as resfile:
		data = infile.read()
		if(data == 'NULL'):
			resfile.write("DNF for uniqueness_initiator: \u2205\n")
			resfile.write("CNF for uniqueness_initiator: \u2205\n")
		else:
			...
			resfile.write("DNF for uniqueness_initiator: "+str(dnf)+"\n")
			resfile.write("CNF for uniqueness_initiator: "+str(cnf)+"\n")

res2dnf("process_read_access/uniqueness_initiator/wireguard_uniqueness_initiator.pv.log")