...
with open('wireguard_secrecy_rsk7_export_queries.spthy', 'w') as f:
	...
	f.write('event(eR_SK7(ck, kemltki, kemltkr, tpkr, kempeki, psk, h((rb, tpki)), h((ra, tpkr)), h(re))) && attacker(ck).'+'\n\n')
...
with open('wireguard_secrecy_rsk7_export_queries.spthy', 'r') as f:
	fdata = f.read()
