...
use crate::wireguard_hybrid::handshake::crypto_params::{SIZE_EPHEMERAL_KEM_CIPHERTEXT, SIZE_EPHEMERAL_KEM_PUB_KEY, SIZE_HASH, SIZE_STATIC_KEM_CIPHERTEXT, SIZE_SM2_POINT, SIZE_XNONCE};
use super::types::*;
...
mod tests {
    ...
    fn message_response_identity() {
        ...
        msg.noise.f_ephemeral = [
            ...
            0x13, 0x56, 0x52, 0x1f, 0x00, // extra byte for SM2 33-byte compressed point
        ];
        msg.noise.f_empty = [
