...
with open('wireguard_unilateral_responder_export_queries.spthy', 'w') as f:
	...
	f.write("query kemltki:bitstring, kemltkr:bitstring, kemltki':bitstring, tpki:bitstring, tpkr:bitstring, kempeki:bitstring, psk:bitstring, ck:bitstring, rb:bitstring, ra:bitstring, re:bitstring, kb:bitstring, ka:bitstring, ke:bitstring;"+'\n')
	...
	for l in sets_list:
		...
		for j in range(0, len(l)):
			...
			query = "query kemltki:bitstring, kemltkr:bitstring, kemltki':bitstring, tpki:bitstring, tpkr:bitstring, kempeki:bitstring, kempeki':bitstring, psk:bitstring, psk':bitstring, ck:bitstring, rb:bitstring, ra:bitstring, re:bitstring, kb:bitstring, ka:bitstring, ke:bitstring"
