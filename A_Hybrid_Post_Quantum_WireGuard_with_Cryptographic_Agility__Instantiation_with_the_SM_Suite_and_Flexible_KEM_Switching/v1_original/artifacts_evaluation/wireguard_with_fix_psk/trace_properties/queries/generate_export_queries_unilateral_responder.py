...
with open('wireguard_unilateral_responder_export_queries.spthy', 'w') as f:
	...
	f.write("query ldhi:bitstring, ldhr:bitstring, dheki:bitstring, dhekr:bitstring, ldhi':bitstring, psk:bitstring, ck:bitstring;"+'\n')
	...
	for l in sets_list:
		...
		for j in range(0, len(l)):
			...
			query = "query ldhi:bitstring, ldhr:bitstring, dheki:bitstring, dhekr:bitstring, ldhi':bitstring, psk:bitstring, ck:bitstring"
			event ="==> (ldhi = ldhi') || "
