...
with open("wireguard_command_11", "r") as infile, open('wireguard_command_11_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_11_1", "r") as infile, open('wireguard_command_11_2', 'w') as outfile:
...
os.remove("wireguard_command_11_1")
...
with open("wireguard_command_11_2", "r") as infile, open('wireguard_command_11_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_2")
...
with open("wireguard_command_11_3", "r") as infile, open('wireguard_command_11_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_3")
...
with open("wireguard_command_11_4", "r") as infile, open('wireguard_command_11_5', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_4")
...
with open("wireguard_command_11_5", "r") as infile, open('wireguard_command_11_6', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_5")
...
with open("wireguard_command_11_6", "r") as infile, open('wireguard_command_11_7', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_6")
...
with open("wireguard_command_11_7", "r") as infile, open('wireguard_command_11_8', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_7")
...
with open("wireguard_command_11_8", "r") as infile, open('wireguard_command_11_9', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_11_8")
...
with open("wireguard_command_11_9", "r") as infile, open('wireguard_command_11_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
		if not any(all( word in line for word in keys) for keys in rep_comb9):
...
os.remove("wireguard_command_11_9")
