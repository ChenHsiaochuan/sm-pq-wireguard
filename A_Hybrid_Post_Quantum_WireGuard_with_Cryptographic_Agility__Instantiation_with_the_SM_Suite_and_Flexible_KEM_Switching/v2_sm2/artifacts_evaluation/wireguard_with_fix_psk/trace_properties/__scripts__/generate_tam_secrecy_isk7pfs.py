...
lemma_header_secrecy_isk7pfs = """lemma Secrecy_ISK7PFS:\nall-traces\n\"\nAll #i #j ldhi ldhr dheki dhekr psk ck.\n(IConfirm(ck, ldhi, ldhr, dheki, dhekr, psk)@i & K(ck)@j & not(Ex #j1. RevPsk(psk)@j1 & (#j1 < #i)) & not(Ex #j2. RevLDH(ldhr)@j2 & (#j2 < #i)) &
...
extract_and_write_expression(input_filename, "secrecy_isk7pfs.cnf", "secrecy_isk7pfs")


generate_tamarin_lemma_secrecy_isk7pfs("secrecy_isk7pfs.cnf", variable_mapping_secrecy, "secrecy_isk7pfs.lemma")