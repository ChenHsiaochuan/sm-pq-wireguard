...
replace_string_in_files("./resolve_simple", "in(att,(=sxI, (sidI_1:bitstring, (dhpekI_1:bitstring, (astat_1:bitstring, (ats_1:bitstring, macI1_1:bitstring))))));", "in(att,(=sxI, (sidI_1:bitstring, (dhpekI_1:bitstring, (astat_1:bitstring, (ats_1:bitstring, macI1_1:bitstring))))));\n\t\t\tnew stp1_1[]:bitstring;\n\t\t\tevent eTest( stp1_1, dhpekI_1 );\n\n")
...
replace_string_in_files("./resolve_simple", "event eRevPsk(bitstring).", "event eRevPsk(bitstring).\nevent eTest(bitstring,bitstring).\n\n")
