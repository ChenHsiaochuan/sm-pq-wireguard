...
with open("wireguard_command_6", "r") as infile, open('wireguard_command_6_1', 'w') as outfile:
	for line in infile :
...
with open("wireguard_command_6_1", "r") as infile, open('wireguard_command_6_2', 'w') as outfile:
...
os.remove("wireguard_command_6_1")
...
with open("wireguard_command_6_2", "r") as infile, open('wireguard_command_6_3', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_6_2")
...
with open("wireguard_command_6_3", "r") as infile, open('wireguard_command_6_4', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_6_3")
...
with open("wireguard_command_6_4", "r") as infile, open('wireguard_command_6_opt', 'w') as outfile:
	lines = infile.readlines()
	filtered_lines = []
	for line in lines :
...
os.remove("wireguard_command_6_4")
